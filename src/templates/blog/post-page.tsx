      ...
      <div className="container space-y-8 px-4 md:px-8">
        ...
        <div className="grid  grid-cols-1 lg:grid-cols-[1fr_300px] gap-6 lg:gap-12">
          <article className="bg-gray-600 rounded-lg overflow-hidden border-gray-400 border-[1px]">
            <figure className="relative aspect-[16/10] w-full overflow-hidden rounded-lg md:rounded-b-none">
              <Image
                src={post?.image ?? ''}
                alt={post?.title ?? ''}
                fill
            ...
            <header className="p-4 md:p-6 lg:p-12 pb-0 mt-8 md:mt-12">
              <h1 className="mb-8 text-heading-lg md:text-heading-lg lg:text-heading-xl">
                {post?.title}
              </h1>
